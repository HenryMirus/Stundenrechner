...
pyinstaller --onefile --windowed --name Stundenrechner --collect-all ttkbootstrap --collect-all msal --hidden-import=requests --hidden-import=msal --paths src --clean main.py
if errorlevel 1 (
